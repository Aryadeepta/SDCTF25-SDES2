# Historical SDCTF 2025 competition solver; not used by the current test suite.
# Its original runtime required Windows cmd, Nmap/ncat, NumPy, and SymPy.
# See src/sdes2/ for the maintained, deterministic implementation.
